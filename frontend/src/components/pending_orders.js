...
class GetDispatchedOrders extends Component {
    ...
    componentDidMount = async () => {
        await axios
            .get('http://localhost:4000/api/orders/get_list/W', { headers: { 'my-auth-token': sessionStorage.getItem('token') } })
            .then(res => {
        ...
        if (!orders) {
            ...
            orderList = orders.map((order) =>
                <tr>
                    ...
                    <td>{order.date}</td>
                    <Link to={"/order/edit/" + order._id}><td>edit</td></Link>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            <br />
                            <h2 className="display-10 text-center">Waiting order List</h2>
                        </div>
                    </div>
                    <table class="table">
                        <thead>
